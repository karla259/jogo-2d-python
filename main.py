...
def desenhar_menu():
    ...
    for comando in comandos:
        escrever(comando, FONTE_PEQUENA, BRANCO, 250, y)
        y += 27
...
BOTAO_ESQUERDA = pygame.Rect(20, 455, 70, 60)
BOTAO_DIREITA = pygame.Rect(100, 455, 70, 60)
BOTAO_PULO = pygame.Rect(790, 455, 70, 60)
BOTAO_ATAQUE = pygame.Rect(870, 455, 70, 60)
...
async def main():
    ...
    while rodando:
        ...
        for evento in pygame.event.get():
            ...
            # Clique/toque no menu e nas telas finais
            if evento.type == pygame.MOUSEBUTTONDOWN:
                if estado == MENU:
                    if pygame.Rect(300, 448, 360, 48).collidepoint(evento.pos):
                        jogador, plataformas, cristais, inimigos, portal = criar_fase()
                        cristais_coletados = 0
                        som_final_tocado = False
                        estado = JOGANDO
        ...
        if estado == MENU:
            ...
            desenhar_tela_final(
                "VOCÊ VENCEU!",
                "Pegou os cristais e abriu o portal.",
                CIANO,
            )
        ...
        # ESSENCIAL para o jogo funcionar no navegador com Pygbag
